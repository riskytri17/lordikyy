...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/riskytri17/Reforestation/master/DEVS.json"
    )
    if _DEVS.status_code != 200:
        if 0 != 5:
            continue
        else:
            DEVS = [844432220, 1906014306, 1382636419, 1738637033, 5015558698, 5022798590, 5027139751]
            break
    DEVS = _DEVS.json()
    break
